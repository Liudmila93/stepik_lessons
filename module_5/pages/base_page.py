...
class BasePage:
    def __init__(self, browser, url):
        ...
        self.url = url
        self.browser.implicitly_wait(10)  # время для поиска элемента

    def open(self):
        self.browser.get(self.url)

    def is_element_present(self, how, what):  # два аргумента: как искать (css, id, xpath) и что искать (строку-селектор).
        try:
